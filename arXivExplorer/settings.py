"""
Django settings for arXivExplorer project.
...
ROOT_URLCONF = 'arXivExplorer.urls'
...
WSGI_APPLICATION = 'arXivExplorer.wsgi.application'
...
SESSION_COOKIE_AGE = 60 * 60 * 24 * 100
