...
STOPWORD = ['a', "a's", 'able', 'about', 'above', 'according', 'accordingly', 'across', 'actually', 'after',
            ...
            "won't", 'wonder', 'would', 'would', "wouldn't", 'x', 'y', 'yes', 'yet', 'you', "you'd", "you'll", "you're",
...
def tokenize(content, split_ext=False):
    if split_ext:
        cc = re.sub(r'[0-9]', ' ', content)
        cc1 = re.sub(r'[^A-Za-z\s]', '', cc)
        return re.findall(r'[a-zA-Z]+', cc1)
    else:
